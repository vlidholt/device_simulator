        ...
        child: MediaQuery(
          ...
          child: Builder(
            builder: (context) {
              ...
              var specs =
                  _platform == TargetPlatform.iOS ? iosSpecs : androidSpecs;
              ...
              if (_platform == TargetPlatform.android &&
                  widget.androidShowNavigationBar)
              ...
              var content = MediaQuery(
                ...
                data: mq.copyWith(
                  size: Size(
                      simulatedSize.width, simulatedSize.height - navBarHeight),
                  padding: padding,
                ),
                child: Theme(
